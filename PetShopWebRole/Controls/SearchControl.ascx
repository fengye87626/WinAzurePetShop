<%@ Control Language="C#" AutoEventWireup="true" Inherits="PetShopWebRole.SearchControl" Codebehind="SearchControl.ascx.cs" %>
<%@ OutputCache Duration="100000" VaryByParam="page;keywords" Shared="true" %>
<%@ Register TagPrefix="PetShopControl" Namespace="PetShopWebRole" Assembly="PetShopWebRole" %>
