...
<div align="center" class="cartPosition">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="387">
        ...
        <tr>
            <td nowrap="nowrap" align="right" width="100%" style="height: 16px"><a href="javascript:history.back();"><img border="0" src="Comm_Images/button-home.gif"></a></td>
            <td align="left" nowrap="nowrap" style="height: 16px"><a class="linkCheckOut" href="javascript:history.back();">Continue Shopping</a></td>
        </tr>
            <tr><td class="linkCheckOut" colspan="2">&nbsp;</td></tr>
        <tr>
